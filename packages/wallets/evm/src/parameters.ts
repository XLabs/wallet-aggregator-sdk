...
/**
 * A map of chain parameters as defined in the {@link https://eips.ethereum.org/EIPS/eip-3085 EIP-3085}, indexed by evm chain ids
 *
 * @see https://chainid.network/chains.json for a complete list
 */
